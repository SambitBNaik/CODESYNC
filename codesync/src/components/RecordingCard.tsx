...
import { calculateRecordigDuration } from "@/lib/utils";
...
function RecordingCard({recording}:{recording: CallRecording}){
    ...
    const duration= recording.start_time && recording.end_time ?  calculateRecordigDuration(recording.start_time, recording.end_time):"Unknown duration";
    return(
      <Card className="group hover:shadow-md transition-all">
        {/* CARD HEADER */}
         <CardHeader className="space-y-1">
            <div className="space-y-2">
                <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex items-center text-sm text-primary-foreground gap-2">
         ...
         <CardContent>
            ...
            >
                <div className="size-12 rounded-full bg-background/90 flex items-center
